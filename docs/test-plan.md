...
**Current automated coverage:** 35 of 41 planned test cases (85.4%). This count is based on the current Playwright spec files and does not represent a test-run result.
